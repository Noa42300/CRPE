/**
 * Affichage complet d'une FICHE D'ANGLAIS
 * ---------------------------------------
 * Ordre : 🧠 À retenir · 📚 Explications (sections avec exemples et
 * tableaux) · ⚠️ Attention. Réutilise les blocs visuels communs.
 */
import { RichText } from "@/components/RichText";
import { Bullets, DataTable, RetenirList, SectionCard } from "@/components/maths/boxes";
import { ANGLAIS_META, type AnglaisFiche } from "@/lib/anglais-fiches/types";

export function AnglaisFicheView({ fiche }: { fiche: AnglaisFiche }) {
  return (
    <article className="mx-auto max-w-3xl">
      {/* En-tête */}
      <span className={`badge border ${ANGLAIS_META.pill}`}>
        {ANGLAIS_META.emoji} {ANGLAIS_META.label}
      </span>
      ...
      <div className="mt-6 flex flex-col gap-5">
        {/* 🧠 À retenir (l'essentiel, en premier) */}
