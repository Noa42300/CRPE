...
/** Nombre du jour : un nombre « au hasard » par niveau (plus le numéro du
 *  jour d'école). CE1 : nombres à deux chiffres. CE2 (P1) : jusqu'à 100. */
export interface NbModule { nce1: number; nce2: number; ce1: QA[]; ce2: QA[]; note?: string; }
export interface CmModule { t: string; but: string; ce1: QA[]; ce2: QA[]; }
export interface PhModule { t: string; f: string; ce1: QA[]; ce2: QA[]; }
export interface PbModule { t: string; aide: string; rep: string; ce1: QA[]; ce2: QA[]; }
...
export const SCRIPTS: Record<string, string> = {
 ...
 nb:"Voici le nombre du jour de chaque niveau. On le lit à voix haute, puis on le décompose : combien de dizaines ? combien d'unités ? Ensuite, chacun répond aux questions sur son ardoise, et on corrige ensemble.",
...
{n:1,j:"Mardi",d:"mardi 1er septembre 2026",c:"01/09/2026",phase:"Installer les rituels",
 ...
 nb:{nce1:24,nce2:63,
     ce1:[["Combien de dizaines et combien d'unités dans 24 ?","2 dizaines et 4 unités"],["Décompose : 24 = … + …","20 + 4"],["Écris 24 en lettres.","vingt-quatre"],["Quel nombre vient juste avant 24 ? juste après ?","23 et 25"]],
     ce2:[["Écris 63 en lettres.","soixante-trois"],["Décompose 63 en dizaines et unités.","6 d + 3 u (60 + 3)"],["Encadre 63 entre deux dizaines.","60 < 63 < 70"],["Ajoute 10 à 63, puis retire 10.","73 et 53"]],
     note:"Nombres pris au hasard (on ne compte plus les jours d'école). CE1 : nombres à deux chiffres ; CE2 : jusqu'à 100 en période 1, on montera jusqu'à 1 000 ensuite."},
 ...
 pb:{t:"Dans la classe, il y a 13 CE1 et 10 CE2.",rep:"Il y a 23 élèves dans la classe (13 + 10). Il y a 3 CE1 de plus que de CE2.",aide:"Faire reformuler l'histoire, puis dessiner deux paquets de jetons au tableau.",
     ce1:[["Combien y a-t-il d'élèves en tout ?","23 élèves (13 + 10)"]],
     ce2:[["Combien y a-t-il d'élèves en tout ?","23 élèves"],["Combien y a-t-il de CE1 de plus que de CE2 ?","3 de plus (13 − 10)"]]},
 bo:null},
...
{n:4,j:"Lundi",d:"lundi 7 septembre 2026",c:"07/09/2026",phase:"Installer les rituels",
 ...
 nb:{nce1:32,nce2:78,
     ce1:[["Combien de dizaines et combien d'unités dans 32 ?","3 dizaines et 2 unités"],["Décompose : 32 = … + …","30 + 2"],["Écris 32 en lettres.","trente-deux"],["Quel nombre vient juste avant 32 ? juste après ?","31 et 33"]],
     ce2:[["Écris 78 en lettres.","soixante-dix-huit"],["Décompose 78 en dizaines et unités.","7 d + 8 u (70 + 8)"],["Encadre 78 entre deux dizaines.","70 < 78 < 80"],["Ajoute 10 à 78, puis retire 10.","88 et 68"]]},
 ...
 pb:{t:"Léa a 24 images. Tom a 42 images.",rep:"Tom a le plus d'images : 42 > 24. Il en a 18 de plus (42 − 24).",aide:"Comparer les nombres (chapitre du jour) : on compare d'abord les dizaines.",
     ce1:[["Qui a le plus d'images ?","Tom (42 > 24)"],["Écris la comparaison avec le bon signe.","24 < 42"]],
     ce2:[["Range 24, 42 et 240 du plus petit au plus grand.","24 < 42 < 240"],["Combien Tom a-t-il d'images de plus que Léa ?","18 de plus (42 − 24)"]]},
 bo:null},
...
{n:5,j:"Mardi",d:"mardi 8 septembre 2026",c:"08/09/2026",phase:"Installer les rituels",
 ...
 nb:{nce1:45,nce2:56,
     ce1:[["Combien de dizaines et combien d'unités dans 45 ?","4 dizaines et 5 unités"],["Décompose : 45 = … + …","40 + 5"],["Écris 45 en lettres.","quarante-cinq"],["Quel nombre vient juste avant 45 ? juste après ?","44 et 46"]],
     ce2:[["Écris 56 en lettres.","cinquante-six"],["Décompose 56 en dizaines et unités.","5 d + 6 u (50 + 6)"],["Encadre 56 entre deux dizaines.","50 < 56 < 60"],["Ajoute 10 à 56, puis retire 10.","66 et 46"]]},
 ...
 pb:{t:"Dans notre classe, il y a 13 CE1 et 10 CE2.",rep:"Il y a 23 élèves dans la classe (13 + 10). Il y a 3 CE1 de plus que de CE2.",aide:"Faire reformuler l'histoire, puis dessiner deux paquets de jetons au tableau.",
     ce1:[["Combien y a-t-il d'élèves en tout ?","23 élèves (13 + 10)"]],
     ce2:[["Combien y a-t-il d'élèves en tout ?","23 élèves"],["Combien y a-t-il de CE1 de plus que de CE2 ?","3 de plus (13 − 10)"]]},
 bo:null},
...
{n:8,j:"Lundi",d:"lundi 14 septembre 2026",c:"14/09/2026",phase:"Installer les rituels",
 ...
 nb:{nce1:27,nce2:91,
     ce1:[["Combien de dizaines et combien d'unités dans 27 ?","2 dizaines et 7 unités"],["Décompose : 27 = … + …","20 + 7"],["Écris 27 en lettres.","vingt-sept"],["Quel nombre vient juste avant 27 ? juste après ?","26 et 28"]],
     ce2:[["Écris 91 en lettres.","quatre-vingt-onze"],["Décompose 91 en dizaines et unités.","9 d + 1 u (90 + 1)"],["Encadre 91 entre deux dizaines.","90 < 91 < 100"],["Ajoute 10 à 91, puis retire 10.","101 et 81"]]},
 ...
 pb:{t:"À la bibliothèque, il y a 46 livres. La maîtresse en apporte 8 de plus.",rep:"Il y a maintenant 54 livres (46 + 8).",aide:"On ajoute : y en a-t-il plus ou moins qu'avant ?",
     ce1:[["Combien de livres y a-t-il maintenant ?","54 livres (46 + 8)"]],
     ce2:[["Combien de livres en tout ?","54 livres"],["La classe en emprunte 19. Combien en reste-t-il ?","35 livres (54 − 19)"]]},
...
{n:9,j:"Mardi",d:"mardi 15 septembre 2026",c:"15/09/2026",phase:"Installer les rituels",
 ...
 nb:{nce1:53,nce2:47,
     ce1:[["Combien de dizaines et combien d'unités dans 53 ?","5 dizaines et 3 unités"],["Décompose : 53 = … + …","50 + 3"],["Écris 53 en lettres.","cinquante-trois"],["Quel nombre vient juste avant 53 ? juste après ?","52 et 54"]],
     ce2:[["Écris 47 en lettres.","quarante-sept"],["Décompose 47 en dizaines et unités.","4 d + 7 u (40 + 7)"],["Encadre 47 entre deux dizaines.","40 < 47 < 50"],["Ajoute 10 à 47, puis retire 10.","57 et 37"]]},
 ...
 pb:{t:"Léa a 24 billes. Elle en gagne 8 pendant la récréation.",rep:"Léa a maintenant 32 billes (24 + 8).",aide:"Faire raconter l'histoire avant de calculer : est-ce qu'elle en a plus ou moins qu'avant ?",
     ce1:[["Combien de billes a-t-elle maintenant ?","32 billes (24 + 8)"]],
...
{n:12,j:"Lundi",d:"lundi 21 septembre 2026",c:"21/09/2026",phase:"Automatiser",
 ...
 nb:{nce1:36,nce2:84,
     ce1:[["Combien de dizaines et combien d'unités dans 36 ?","3 dizaines et 6 unités"],["Décompose : 36 = … + …","30 + 6"],["Écris 36 en lettres.","trente-six"],["Quel nombre vient juste avant 36 ? juste après ?","35 et 37"]],
     ce2:[["Écris 84 en lettres.","quatre-vingt-quatre"],["Décompose 84 en dizaines et unités.","8 d + 4 u (80 + 4)"],["Encadre 84 entre deux dizaines.","80 < 84 < 90"],["Ajoute 10 à 84, puis retire 10.","94 et 74"]]},
 ...
 pb:{t:"Sur le parking, il y a 38 voitures. 25 voitures arrivent.",rep:"Il y a 63 voitures en tout (38 + 25).",aide:"Additionner en passant la dizaine (38 + 2 → 40, puis 23).",
     ce1:[["Combien de voitures y a-t-il en tout ?","63 voitures (38 + 25)"]],
     ce2:[["Combien de voitures en tout ?","63 voitures"],["Puis 47 voitures repartent. Combien reste-t-il ?","16 voitures (63 − 47)"]]},
 bo:null},
...
{n:13,j:"Mardi",d:"mardi 22 septembre 2026",c:"22/09/2026",phase:"Automatiser",
 ...
 nb:{nce1:48,nce2:69,
     ce1:[["Combien de dizaines et combien d'unités dans 48 ?","4 dizaines et 8 unités"],["Décompose : 48 = … + …","40 + 8"],["Écris 48 en lettres.","quarante-huit"],["Quel nombre vient juste avant 48 ? juste après ?","47 et 49"]],
     ce2:[["Écris 69 en lettres.","soixante-neuf"],["Décompose 69 en dizaines et unités.","6 d + 9 u (60 + 9)"],["Encadre 69 entre deux dizaines.","60 < 69 < 70"],["Ajoute 10 à 69, puis retire 10.","79 et 59"]]},
 ...
 pb:{t:"Le maître achète 5 paquets de 10 crayons.",rep:"Le maître a 50 crayons (5 × 10).",aide:"Laisser dessiner les 5 paquets. Faire verbaliser : « 5 fois 10 ».",
     ce1:[["Combien de crayons a-t-il en tout ?","50 crayons"]],
...
{n:16,j:"Lundi",d:"lundi 28 septembre 2026",c:"28/09/2026",phase:"Automatiser",
 ...
 nb:{nce1:29,nce2:72,
     ce1:[["Combien de dizaines et combien d'unités dans 29 ?","2 dizaines et 9 unités"],["Décompose : 29 = … + …","20 + 9"],["Écris 29 en lettres.","vingt-neuf"],["Quel nombre vient juste avant 29 ? juste après ?","28 et 30"]],
     ce2:[["Écris 72 en lettres.","soixante-douze"],["Décompose 72 en dizaines et unités.","7 d + 2 u (70 + 2)"],["Encadre 72 entre deux dizaines.","70 < 72 < 80"],["Ajoute 10 à 72, puis retire 10.","82 et 62"]]},
 cm:{t:"On corse : dizaines, compléments à 100, tables",but:"CE1 : additions/soustractions de dizaines, aller jusqu'à 100. CE2 : deux tables de multiplication parmi les six calculs.",
     ce1:[["30 + 10","40"],["40 + 20","60"],["60 + 40","100"],["50 − 20","30"],["45 + 5","50"],["70 − 30","40"]],
     ce2:[["50 − 20","30"],["2 × 8","16"],["5 × 6","30"],["100 − 30","70"],["75 − 40","35"],["64 + 20","84"]]},
 ...
 pb:{t:"Un livre a 90 pages. Tom a déjà lu 34 pages.",rep:"Il reste 56 pages à lire (90 − 34).",aide:"Retirer : ce qu'il reste (90 − 34).",
     ce1:[["Combien de pages lui reste-t-il à lire ?","56 pages (90 − 34)"]],
     ce2:[["Combien de pages reste-t-il ?","56 pages"],["S'il lit 20 pages par jour, en combien de jours aura-t-il fini ?","3 jours (56 → 36 → 16 → 0)"]]},
...
{n:17,j:"Mardi",d:"mardi 29 septembre 2026",c:"29/09/2026",phase:"Automatiser",
 ...
 nb:{nce1:61,nce2:95,
     ce1:[["Combien de dizaines et combien d'unités dans 61 ?","6 dizaines et 1 unité"],["Décompose : 61 = … + …","60 + 1"],["Écris 61 en lettres.","soixante et un"],["Quel nombre vient juste avant 61 ? juste après ?","60 et 62"]],
     ce2:[["Écris 95 en lettres.","quatre-vingt-quinze"],["Décompose 95 en dizaines et unités.","9 d + 5 u (90 + 5)"],["Encadre 95 entre deux dizaines.","90 < 95 < 100"],["Ajoute 10 à 95, puis retire 10.","105 et 85"]]},
 cm:{t:"Passer la dizaine (plus costaud)",but:"CE1 : sommes et différences de dizaines, un calcul jusqu'à 100. CE2 : deux multiplications parmi les six calculs.",
     ce1:[["30 + 40","70"],["20 + 30","50"],["60 + 40","100"],["50 − 10","40"],["40 + 40","80"],["90 − 30","60"]],
     ce2:[["27 + 5","32"],["5 × 7","35"],["2 × 9","18"],["73 + 8","81"],["35 + 20","55"],["100 − 45","55"]]},
 ...
 pb:{t:"Dans la classe, il y a 6 tables. À chaque table, 4 élèves peuvent s'asseoir.",rep:"24 élèves peuvent s'asseoir (6 × 4).",aide:"Autoriser le dessin des 6 tables. Faire dire : « 6 fois 4 ».",
...
{n:20,j:"Lundi",d:"lundi 5 octobre 2026",c:"05/10/2026",phase:"Consolider",
 ...
 nb:{nce1:54,nce2:58,
     ce1:[["Combien de dizaines et combien d'unités dans 54 ?","5 dizaines et 4 unités"],["Décompose : 54 = … + …","50 + 4"],["Écris 54 en lettres.","cinquante-quatre"],["Quel nombre vient juste avant 54 ? juste après ?","53 et 55"]],
     ce2:[["Écris 58 en lettres.","cinquante-huit"],["Décompose 58 en dizaines et unités.","5 d + 8 u (50 + 8)"],["Encadre 58 entre deux dizaines.","50 < 58 < 60"],["Ajoute 10 à 58, puis retire 10.","68 et 48"]]},
 cm:{t:"Multiplier par 2 et par 5",but:"CE1 : doubles et dizaines, jusqu'à 100 (les tables viendront après). CE2 : deux tables (×2, ×5) parmi les six calculs.",
     ce1:[["30 + 30","60"],["40 + 40","80"],["50 + 50","100"],["60 + 20","80"],["Double de 20","40"],["90 − 30","60"]],
     ce2:[["5 × 5","25"],["2 × 9","18"],["80 + 20","100"],["45 + 30","75"],["96 − 40","56"],["70 + 30","100"]]},
 ...
 pb:{t:"Le maître range les crayons par paquets de 10. Il a 6 paquets.",rep:"Le maître a 60 crayons (6 × 10).",aide:"6 fois 10 : faire le lien avec la multiplication par 10.",
     ce1:[["Combien de crayons a-t-il en tout ?","60 crayons (6 × 10)"]],
     ce2:[["Combien de crayons en tout ?","60 crayons"],["Il ajoute 4 paquets de 10. Combien en a-t-il alors ?","100 crayons (10 paquets de 10)"]]},
...
{n:21,j:"Mardi",d:"mardi 6 octobre 2026",c:"06/10/2026",phase:"Consolider",
 ...
 nb:{nce1:38,nce2:87,
     ce1:[["Combien de dizaines et combien d'unités dans 38 ?","3 dizaines et 8 unités"],["Décompose : 38 = … + …","30 + 8"],["Écris 38 en lettres.","trente-huit"],["Quel nombre vient juste avant 38 ? juste après ?","37 et 39"]],
     ce2:[["Écris 87 en lettres.","quatre-vingt-sept"],["Décompose 87 en dizaines et unités.","8 d + 7 u (80 + 7)"],["Encadre 87 entre deux dizaines.","80 < 87 < 90"],["Ajoute 10 à 87, puis retire 10.","97 et 77"]]},
 cm:{t:"Aller au nombre rond + tables",but:"CE1 : compléments à la dizaine/centaine, un calcul à 100. CE2 : deux multiplications parmi les six calculs.",
     ce1:[["27 pour aller à 30","3"],["36 pour aller à 40","4"],["40 + 60","100"],["50 + 30","80"],["80 − 30","50"],["45 + 30","75"]],
     ce2:[["85 pour aller à 100","15"],["5 × 8","40"],["3 × 4","12"],["230 pour aller à 300","70"],["96 pour aller à 100","4"],["150 + 50","200"]]},
 ...
 pb:{t:"Dans le car, il y a 48 places. 29 élèves sont déjà assis.",rep:"Il reste 19 places libres (48 − 29).",aide:"Faire schématiser le car : ce qui est occupé, ce qui reste.",
     ce1:[["Combien de places sont encore libres ?","19 places (48 − 29)"]],
...
{n:24,j:"Lundi",d:"lundi 12 octobre 2026",c:"12/10/2026",phase:"Consolider",
 ...
 nb:{nce1:42,nce2:66,
     ce1:[["Combien de dizaines et combien d'unités dans 42 ?","4 dizaines et 2 unités"],["Décompose : 42 = … + …","40 + 2"],["Écris 42 en lettres.","quarante-deux"],["Quel nombre vient juste avant 42 ? juste après ?","41 et 43"]],
     ce2:[["Écris 66 en lettres.","soixante-six"],["Décompose 66 en dizaines et unités.","6 d + 6 u (60 + 6)"],["Encadre 66 entre deux dizaines.","60 < 66 < 70"],["Ajoute 10 à 66, puis retire 10.","76 et 56"]]},
 cm:{t:"Dizaines, centaines et tables",but:"CE1 : additions de dizaines, un calcul à 100. CE2 : multiplier (tables et × 10).",
     ce1:[["20 + 30","50"],["60 + 40","100"],["50 + 20","70"],["30 + 30","60"],["80 + 20","100"],["70 − 30","40"]],
     ce2:[["7 × 5","35"],["3 × 8","24"],["10 × 10","100"],["45 + 30","75"],["120 + 80","200"],["96 − 40","56"]]},
 ...
 pb:{t:"Dans la classe, il y a 6 tables de 4 places. 3 places sont cassées.",rep:"Il y a 21 places utilisables : 6 × 4 = 24, puis 24 − 3.",aide:"6 fois 4, puis on enlève les places cassées.",
     ce1:[["Combien de places y a-t-il en tout ?","24 places (6 × 4)"]],
     ce2:[["Combien de places sont utilisables ?","21 places (24 − 3)"],["La classe compte 23 élèves : y a-t-il assez de places ?","non, il manque 2 places"]]},
...
{n:25,j:"Mardi",d:"mardi 13 octobre 2026",c:"13/10/2026",phase:"Consolider — dernier jour de la période",
 ...
 nb:{nce1:57,nce2:99,
     ce1:[["Combien de dizaines et combien d'unités dans 57 ?","5 dizaines et 7 unités"],["Décompose : 57 = … + …","50 + 7"],["Écris 57 en lettres.","cinquante-sept"],["Quel nombre vient juste avant 57 ? juste après ?","56 et 58"]],
     ce2:[["Écris 99 en lettres.","quatre-vingt-dix-neuf"],["Décompose 99 en dizaines et unités.","9 d + 9 u (90 + 9)"],["Encadre 99 entre deux dizaines.","90 < 99 < 100"],["Ajoute 10 à 99, puis retire 10.","109 et 89"]],
     note:"Dernier nombre du jour de la période : CE2 tout proche de 100. En période 2, on passera aux nombres jusqu'à 1 000."},
 cm:{t:"Le défi de fin de période",but:"Bilan : ce qui est automatisé et ce qui sera repris en période 2. CE1 corsé (jusqu'à 100), CE2 avec des multiplications.",
     ce1:[["Double de 7","14"],["40 + 60","100"],["30 + 30","60"],["Moitié de 16","8"],["90 − 40","50"],["Le nombre après 99","100"]],
     ce2:[["Double de 30","60"],["5 × 6","30"],["3 × 7","21"],["70 + ? = 100","30"],["24 × 10","240"],["300 − 100","200"]]},
 ...
 pb:{t:"La classe part à la bibliothèque. Il y a 23 élèves et 2 adultes. Chaque élève emprunte 2 livres. Le trajet dure 15 minutes.",rep:"Les élèves empruntent 46 livres en tout (23 × 2). Le trajet (15 min) et les 2 adultes ne servaient pas au calcul.",
